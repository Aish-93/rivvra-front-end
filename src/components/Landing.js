  ...
  return (
    ...
    <div className="bg-gray-100 text-gray-900">
      ...
      <header className=" bgColor text-white py-20 text-center">
        ...
        <p className="mt-4 text-lg">CRM software designed to make sales simple and effective.</p>
      ...
      <section className="py-16 max-w-6xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          <div className="p-6 bg-white shadow rounded-lg">
            ...
            <p className="mt-2 text-gray-600">Save time with smart automation tools.</p>
          </div>
          <div className="p-6 bg-white shadow rounded-lg">
            <h3 className="text-xl font-bold">Detailed Insights</h3>
            <p className="mt-2 text-gray-600">Gain va;luable data to improve sales performance.</p>
          </div>
          <div className="p-6 bg-white shadow rounded-lg">
            <h3 className="text-xl font-bold">Easy Integration</h3>
            <p className="mt-2 text-gray-600">Seamlessly connects with your favorite tools.</p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-gray-200 py-16 text-center">
        ...
        <div className="mt-8 max-w-4xl mx-auto">
          <blockquote className="text-xl italic">“This CRM transformed our sales process and boosted our revenue.”</blockquote>
      ...
      <section className="py-16 text-center">
        <h2 className="text-3xl font-semibold">Start Closing More Deals Today</h2>
