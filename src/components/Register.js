      ...
      <div className="border-blue-500 border-2 mt-[100] px-5  rounded-2xl h-[630px] flex justify-evenly align-middle ml-auto mr-auto flex-col w-[750px] ">
           ...
           <div>
            ...
            <div className='flex flex-row justify-center  py-2'>
                <p className='flex flex-row align-middle px-2'> <TiTick/>A CRM by salespeople, for salespeople </p>
                <p  className='flex flex-row px-2'> <TiTick/> Easy to customize and organize</p>
            </div>
            <p className='text-base w-[550] text-center mr-auto ml-auto pb-4'>Start with access to Rivvra CRM plus the premium LeadBooster, Smart Docs and Projects Features (subject to supplemental terms). Your Plan and Feature access can be changed at any time.</p>
           <p className='text-base font-bold bg-green-100 text-green-800 w-[340px] ml-auto mr-auto text-center rounded-xl'> 100% access. No credit card required</p>
           </div>
                ...
                <div>
                  <div className=" flex justify-items-start m-3 ml-2">
                    ...
                    <div className=" ml-5">
                      ...
                      <a className='text-blue-500'>Terms of service</a> and <a className='text-blue-500'>privacy policy</a>{" "}
                    </div>
                  </div>
                  <div className=" flex justify-items-start m-3 ml-2">
                    <input type="checkbox" className='scale-150 accent-blue-600' />
                  ...
                  <div className='flex flex-row py-4'><p>Already have an account ? </p><Link to="/login" className='text-blue-950 font-boldbold'> Log in</Link></div>
                </div>
              </div>
            ) : (
              <div>
                ...
                <button
                  ...
                  disabled={loading}
                >
                 <Link to="/signup"> {loading ? "Verifying..." : "Verify Otp"}</Link>
                </button>
              </div>
            )}
          </div>
